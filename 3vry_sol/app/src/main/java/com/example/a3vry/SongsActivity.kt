...
interface YouTubeApiService {
    ...
    @GET("search?key=$YOUTUBE_KEY_API&part=snippet&type=video&videoSyndicated=true&maxResults=50&topicId=/m/04rlf&videoCategoryId=10&order=viewCount")
    ...
    @GET("playlistItems?key=$YOUTUBE_KEY_API&part=snippet&type=video&videoSyndicated=true&maxResults=50&playlistId=PLCrKXyV2OjXi2VF42Dimxvv9fnOH3JEl6")
